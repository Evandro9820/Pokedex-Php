...
<body class="d-flex flex-column justify-content-center align-items-center bg-light fs-5">
    ...
    <div class="d-flex justify-content-center w-100 gap-5">
        ...
        <div>
            ...
            <form class="d-flex flex-column gap-4" id="formCadastro" action="home.php" method="post">
                <header>
                    <h3>Cadastrar Pokémon</h3>
                </header>

                <div>
                    <input type="text" class="rounded-4 p-3 border-0 bg-white" placeholder="Nome do pokemon" id="nome_pokemon" name="nome_pokemon" required>
                </div>

                <div>
                    <input type="text" class="rounded-4 p-3 border-0 bg-white" placeholder="Seu tipo" id="tipo_pokemon" name="tipo_pokemon" required>
                </div>
            ...
            <form class="d-flex flex-column gap-4 d-none" id="formEdicao" action="home.php" method="post">
                <header>
                ...
                <div>
                    <input type="text" class="rounded-4 p-3 border-0 bg-white" placeholder="Nome do pokemon" id="nome_pokemon_edit" name="nome_pokemon" required>
                </div>

                <div>
                    <input type="text" class="rounded-4 p-3 border-0 bg-white" placeholder="Seu Tipo" id="tipo_pokemon_edit" name="tipo_pokemon" required>
                </div>

                <div>
                    <button type="submit" class="btn btn-primary rounded-4 p-3 border-0 text-white" name="editar">Salvar
                        Edição</button>
                    <button type="button" class="btn btn-danger rounded-4 p-3 border-0 text-white" onclick="exibirFormularioCadastro()">Cancelar
                        Edição</button>
                </div>
            </form>
        </div>
